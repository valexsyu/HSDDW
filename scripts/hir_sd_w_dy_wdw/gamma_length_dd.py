...
def update_file_path(experiment, dataset, gamma) :
    ...
    LENGTH_FILE_NAME={
        ...
        '70b_1b' : ROOT + f'new_experiments/{dataset}/{gamma}_70b_1b_topkp0_fp16_2048tok/sp_output_length_{gamma}_70b_1b_topkp0_fp16_2048tok.csv',
        '70b_68m' : ROOT + f'experiments/{dataset}/sp_dy_gamma_{gamma}_70b_68m_topkp0_fp16_2048tok_record_only/sp_dy_gamma_etp_output_length_sp_dy_gamma_{gamma}_70b_68m_topkp0_fp16_2048tok.csv',
    ...
    TIME_FILE_NAME={
        ...
        '70b_1b' : ROOT + f'new_experiments/{dataset}/{gamma}_70b_1b_topkp0_fp16_2048tok/sp_time_{gamma}_70b_1b_topkp0_fp16_2048tok.csv',
        '70b_68m' : ROOT + f'experiments/{dataset}/sp_dy_gamma_{gamma}_70b_68m_topkp0_fp16_2048tok_record_only/sp_dy_gamma_etp_time_sp_dy_gamma_{gamma}_70b_68m_topkp0_fp16_2048tok.csv',
    ...
    ACCEPTED_FILE_NAME={
        ...
        '70b_1b' : ROOT + f'new_experiments/{dataset}/{gamma}_70b_1b_topkp0_fp16_2048tok/sp_accepted_sequence_{gamma}_70b_1b_topkp0_fp16_2048tok.csv',
        '70b_68m' :ROOT + f'experiments/{dataset}/sp_dy_gamma_{gamma}_70b_68m_topkp0_fp16_2048tok_record_only/sp_dy_gamma_etp_accepted_sequence_sp_dy_gamma_{gamma}_70b_68m_topkp0_fp16_2048tok.csv',
        ...
        if os.path.exists(sequence_time_path) and os.path.exists(sequence_length_path):
            ...
            if time_values and length_values:
                ...
                if bl_value != "N/A" and bl_value != 0:
                    ...
                    ratio = "N/A"
                experiment_df.at[experiment, gamma] = round(avg_value-0.5, 2)
        else:
...
# 添加標題和標籤
plt.title('The Speed of Different Window Size',fontsize=20)
plt.xlabel('Window Size', fontsize=20)  # 設定 X 軸標籤字體大小為 14
plt.ylabel('Speed (toks/sec)', fontsize=20)  # 設定 Y 軸標籤字體大小為 14
plt.legend(fontsize=20)  # 圖例固定在右上角


# 儲存圖像
output_file = ROOT + f"scripts/hir_sd_w_dy_wdw/figs/{dataset}_Speed_dynamic_and_baseline_gamma_plot_dd.png"
