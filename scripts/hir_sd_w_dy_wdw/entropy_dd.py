...
base_dir = ROOT + "experiments/"+dataset
# 定義範圍
gamma = 10
...
# 添加標題和標籤
plt.title('Accepted vs Reject Entropy',fontsize=24)
plt.xlabel('Data Index', fontsize=20)
plt.ylabel('Average Entropy', fontsize=20)
plt.ylim(top=5)  # 設定 y 軸的最大值為 12
# plt.legend(fontsize=20)
plt.legend(fontsize=20, loc='upper right', bbox_to_anchor=(1, 1))
# 儲存圖像
output_file = ROOT + f"/scripts/hir_sd_w_dy_wdw/figs/Entropy_vs_Gamma_{dataset}_dd.png"
