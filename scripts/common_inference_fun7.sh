# common_functions.sh
#from scripts/common_inference_fun6.sh, add temperature
...
run_experiments() {
    ...
    do 
        ...
        do
            echo "=========$dataset_name + $fn_name Start======${i}_${model}_topkp0_temp${temperature}_fp16_2048tok${use_dy_gamma_suffix}==========="
            
            python main_modify.py \
                --input "The quick brown fox jumps over the lazy " \
                --file_root $root_path/${dataset_name}/sp_dy_gamma_${i}_${model}_topkp0_temp${temperature}_fp16_2048tok${use_dy_gamma_suffix} \
